...
class AddVaccine extends React.Component {
  ...
  render() {
    ...
    // Function for uploading an image. Creates a Form Data that stores cloudinary account and image information.
    // The uses Axios module to send that information to cloudinary. After image url is generated by cloudinary it is retrieved and stored into mongodb.
    // Reference for upload: PedroTech, Youtube, 08/10/21, "How to Upload Images in ReactJS using Cloudinary Tutorial",
          ...
          <Grid.Column width={8}>
            ...
            <AutoForm ref={ref => {
              ...
              <Segment>
                ...
                <p style={{ marginBottom: '-5px', marginTop: '5px', fontSize: '13px' }}><strong>Upload
                    Vaccine</strong></p>
                <input
                ...
                />
                <Header as='h5' style={{ marginTop: '0px', color: 'red' }}> Image size must be under 10 MB and must be
                    a PNG or JPEG. </Header>
